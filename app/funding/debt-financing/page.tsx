    ...
    <main className="bg-white">
      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="bg-[#A00A20]/5 border border-[#A00A20]/10 rounded-[20px] sm:rounded-[30px] lg:rounded-[35px] p-6 sm:p-8 lg:p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-7 md:gap-8 mt-12 sm:mt-16">
            ...
            {[
              ...
              <div
                ...
                "
              >
                <div className="text-[#A00A20] text-4xl sm:text-5xl font-black">
                  0{index + 1}
                </div>
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <p className="mt-4 sm:mt-6 max-w-[950px] mx-auto text-sm sm:text-base md:text-lg lg:text-xl text-black/60 leading-relaxed">
