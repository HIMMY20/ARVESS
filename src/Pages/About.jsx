  ...
  <div className="container">
    ...
    <div className="about-grid">
      ...
      <div className="grid-text reveal">
        ...
        <h2>
          House Of <span>Startups</span>
        </h2>

        <p>
          A framework. A philosophy. A movement.
          <br /><br />
          Arvess is built to support founders at every stage — from
          incorporation and compliance to funding, branding, and
          sustainable growth.
        </p>
      </div>
      ...
      <div className="col-lg-6">
        <div className="mv-card mission-card">
          ...
          <div className="mv-content">
            ...
            <p>
              At Arvess, our mission is to simplify and strengthen the startup
              journey through a unified platform that delivers legal clarity,
              financial fuel, brand power, and strategic insight — tailored for
              India’s evolving entrepreneurial ecosystem.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mv-card vision-card">
          ...
          <div className="mv-content">
            ...
            <p>
              ...
              partner — where innovation meets execution, and founders receive
              the right guidance to turn bold ideas into scalable and
    ...
    <div className="row align-items-center">
      ...
      <div className="col-lg-6 arvess-why-content">
        ...
        <p className="lead-text">
          Arvess is not just a consultancy — it is a structured growth partner
          built to support startups, MSMEs, and entrepreneurs across every
  ...
  <div className="container">
    ...
    <div className="industries-grid">
      ...
      <div className="industry-card">
        ...
        <p>Healthcare innovation, diagnostics, and medical technologies.</p>
      </div>
      ...
      <div className="industry-card">
        <div className="icon">🤖</div>
        <h5>AI & Deep Tech</h5>
        <p>Artificial Intelligence, automation, and deep technology startups.</p>
      </div>
      ...
      <div className="industry-card">
        <div className="icon">🚗</div>
        <h5>EV & Mobility</h5>
        <p>Electric vehicles, mobility platforms, and transport innovation.</p>
      </div>
