  ...
  return (
    <>
      <section className="ci-section">
        <div className="ci-container">
          <div className="ci-content">
            <h1>Secure Your Startup India Recognition</h1>

            <p>
              Register your venture under the Startup India initiative with
              Arvess and gain access to government-backed benefits, tax reliefs,
              and growth-focused funding programs. Our team manages the complete
              application journey, ensuring accuracy, speed, and strict
              adherence to DPIIT norms.
            </p>

            <div className="ci-free-box">
              <h4>What Comes with Startup India Registration</h4>
              ...
              <div className="ci-icons">
                <div className="ci-item">
                  ...
                  <p>
                    We evaluate your business model and structure to confirm
                    Startup India qualification.
                  </p>
                </div>

                <div className="ci-item">
                  <span>📜</span>
                  <p>DPIIT Startup Certificate</p>
                  <p>
                    End-to-end support for obtaining official recognition from
                    DPIIT.
                  </p>
                </div>
                ...
                <div className="ci-item">
                  <span>💰</span>
                  <p>Tax Benefit Advisory</p>
                  <p>
                    Guidance on applicable income tax exemptions and related
                ...
                <div className="ci-item">
                  <span>🛡️</span>
                  <p>Ongoing Compliance Assistance</p>
                  <p>
                    Continued support to help you stay aligned with regulatory
      ...
      <section className="startup-benefits-section">
        <h2 className="startup-benefits-title">
          Advantages of Startup India Recognition
        </h2>

        <div className="startup-benefits-wrap">
          <div className="startup-benefit">
            <span>01</span>
            <h4>Access to Government Capital</h4>
            <p>
              Unlock startup-focused grants, seed funding programs, and
              innovation-led government schemes designed to support early and
